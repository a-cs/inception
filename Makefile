DOMAIN = $(shell awk '/acarneir.42.fr/{print $$2}' /etc/hosts)
VOLUMES = $(shell docker volume ls -q)
IMAGES = $(shell docker images -q)

all: hosts
	sudo mkdir -p /home/acarneir/data/mysql && sudo mkdir -p /home/acarneir/data/wordpress
